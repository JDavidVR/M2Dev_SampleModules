...
class Working implements \Magento\Framework\Setup\InstallDataInterface
{
    /**
            ...
            foreach ($attributeList as $attributeCode => $attributeConfig) {
                ...
                if ($attributeConfig['additional']) {
                    ...
                    try {
                        ...
                        $id = $eavSetup->getAttributeId($entityTypeCode, $attributeCode);

                        /** @var \Magento\Customer\Model\Attribute $attribute */
                        $attribute = $this->customerAttributeFactory->create();
                        $this->customerAttributeResource->load($attribute, $id);
                        $attribute->addData([
                        ...
                        // $this->eventManager->dispatch('customer_entity_attribute_save_commit_after', ['attribute' => $attribute]);
